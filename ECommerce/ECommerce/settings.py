...
SECRET_KEY = 'nvd_te#%k@hv!no+^t_3643tv#+6vr-(w)&y^#j$x68)f7^w1^'
...
MIDDLEWARE_CLASSES = [
    ...
    'corsheaders.middleware.CorsMiddleware',#referencia cruzada
    'django.middleware.common.CommonMiddleware',#referencia cruzada
]
